...
#  Feb 16, 2023 05:15:53 PM +0330  platform: Windows NT
set vTcl(timestamp) ""
...
### SPOT dump_widget_opt A
    ...
    ttk::button "$top.tBu49" \
        -takefocus {} -text "Disconnect" -compound left 
    vTcl:DefineAlias "$top.tBu49" "dis" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
...
### SPOT dump_widget_opt A
    ...
    vTcl:DefineAlias "$site_3_0.scr56" "console" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    ...
    ttk::entry "$site_3_0.tEn57" \
        ...
        -cursor ibeam 
    vTcl:DefineAlias "$site_3_0.tEn57" "user_message" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    ttk::style configure TButton -background $vTcl(actual_gui_bg)
    ttk::style configure TButton -foreground $vTcl(actual_gui_fg)
    ttk::style configure TButton -font "$vTcl(actual_gui_font_dft_desc)"
    ...
    vTcl:DefineAlias "$site_3_0.tBu58" "send" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    ttk::style configure TButton -background $vTcl(actual_gui_bg)
    ttk::style configure TButton -foreground $vTcl(actual_gui_fg)
    ttk::style configure TButton -font "$vTcl(actual_gui_font_dft_desc)"
    ...
    vTcl:DefineAlias "$site_3_0.tBu59" "proj_send" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    text "$site_3_0.tex60" \
    ...
    vTcl:DefineAlias "$site_3_0.tex60" "about" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    text "$site_3_0.tex61" \
        -background white -font "TkTextFont" -foreground black -height 94 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -insertbackground black -selectbackground #c4c4c4 \
        -selectforeground black -state disabled -width 294 -wrap word 
    $site_3_0.tex61 configure -font "TkTextFont"
    $site_3_0.tex61 insert end text
    vTcl:DefineAlias "$site_3_0.tex61" "connected_users" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    ttk::style configure TButton -background $vTcl(actual_gui_bg)
    ttk::style configure TButton -foreground $vTcl(actual_gui_fg)
    ttk::style configure TButton -font "$vTcl(actual_gui_font_dft_desc)"
    ttk::button "$site_3_0.tBu62" \
        -takefocus {} -text "Send File" -compound left 
    vTcl:DefineAlias "$site_3_0.tBu62" "send_file" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    ...
    place $site_3_0.tex61 \
        -in $site_3_0 -x 0 -relx 0.47 -y 0 -rely 0.052 -width 0 \
        -relwidth 0.511 -height 0 -relheight 0.244 -anchor nw \
        -bordermode ignore 
    place $site_3_0.tBu62 \
        -in $site_3_0 -x 0 -relx 0.33 -y 0 -rely 0.909 -width 76 -relwidth 0 \
        -height 25 -relheight 0 -anchor nw -bordermode ignore 
    ttk::style configure TFrame -background $vTcl(actual_gui_bg)
    ttk::frame "$top.tFr52" \
...
### SPOT dump_widget_opt A
    ...
    ttk::button "$top.tBu48" \
        -takefocus {} -text "Destroy Server " -compound left 
    vTcl:DefineAlias "$top.tBu48" "close_server" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    button "$top.but49" \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -state disabled -text "Hotbird Connected Server" 
    vTcl:DefineAlias "$top.but49" "pooch" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    ###################
    # SETTING GEOMETRY
    ###################
    ...
    place $top.tBu48 \
        -in $top -x 0 -relx 0.167 -y 0 -rely 0.933 -width 86 -relwidth 0 \
        -height 25 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but49 \
        -in $top -x 0 -relx 0.733 -y 0 -rely 0.933 -width 157 -relwidth 0 \
