...
#    Feb 16, 2023 05:19:24 PM +0330  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.TFrame2.configure(relief="groove")
        self.close_server = ttk.Button(self.top)
        self.close_server.place(relx=0.167, rely=0.933, height=25, width=86)
        self.close_server.configure(takefocus="")
        self.close_server.configure(text='''Destroy Server''')
        self.close_server.configure(compound='left')
