...
#  Feb 03, 2023 05:55:09 AM +0330  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        -menu "$top.m51" -relief groove -background $vTcl(actual_gui_bg) 
    wm focusmodel $top passive
    wm geometry $top 400x200+657+165
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
### SPOT dump_widget_opt A
    ...
    ttk::button "$top.tBu50" \
        -takefocus {} -text "Clone" -compound left 
...
### SPOT dump_widget_opt A
    ...
    ###################
    place $top.tex49 \
        -in $top -x 10 -y 10 -width 244 -relwidth 0 -height 174 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.tBu50 \
        -in $top -x 260 -y 10 -width 126 -relwidth 0 -height 175 -relheight 0 \
        -anchor nw -bordermode ignore 
