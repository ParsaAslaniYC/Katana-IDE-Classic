...
#-------------------------------------------------------------------------------
# An autocompleting combobox widget incorporated into SEEMAN as a custom control,
# with a SEEMAN alias of cmbTest. The new widget is in the ttkwidgets package,
