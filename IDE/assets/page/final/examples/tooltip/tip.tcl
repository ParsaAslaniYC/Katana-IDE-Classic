...
#  Apr 10, 2022 12:04:23 PM PDT  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black 
    wm focusmodel $top passive
    wm geometry $top 516x313+905+386
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    button $top.but44 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text Change 
    vTcl:DefineAlias "$top.but44" "btn_change" vTcl:WidgetProc "Toplevel1_1" 1
    button $top.but45 \
        -activebackground $vTcl(analog_color_m) -activeforeground black \
        -background $vTcl(actual_gui_bg) -disabledforeground #b8a786 \
        -font $vTcl(actual_gui_font_dft_desc) \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text Dest 
    vTcl:DefineAlias "$top.but45" "btn_dest" vTcl:WidgetProc "Toplevel1_1" 1
    bind $top.but45 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Destination}
    }
    button $top.but46 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -image stop_png -text Quit 
    vTcl:DefineAlias "$top.but46" "btn_quit" vTcl:WidgetProc "Toplevel1_1" 1
    message $top.mes43 \
        -background $vTcl(actual_gui_bg) \
        -font {-family {DejaVu Sans} -size 12} \
        -foreground $vTcl(actual_gui_fg) \
...
tooltip to the "Quit" button.} \
        -width 326 
    vTcl:DefineAlias "$top.mes43" "Message1" vTcl:WidgetProc "Toplevel1_1" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.but44 \
