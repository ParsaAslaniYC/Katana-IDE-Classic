...
#  Jul 16, 2022 05:00:19 PM +0430  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top34 {base} {
    ...
    vTcl:withBusyCursor {
    text $top.tex35 \
        -background white -font TkFixedFont -foreground black -height 61 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -insertbackground black -selectbackground #ddc8a1 \
        -selectforeground black -width 173 -wrap word 
    ...
    vTcl:DefineAlias "$top.cus47" "Custom1" vTcl:WidgetProc "Toplevel1" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.tex35 \
        -in $top -x 0 -y 0 -width 173 -relwidth 0 -height 61 -relheight 0 \
    ...
    place $top.cpd39 \
        ...
        -anchor nw -bordermode ignore 
    place $top.cus47 \
        -in $top -x 40 -y 110 -width 114 -relwidth 0 -height 70 -relheight 0 \
        -anchor nw -bordermode ignore 
