...
[Setup]
    ...
    UsePreviousGroup=1
    AppVersion=7.6
    AppVerName=PAGE - A Python GUI Generator 7.6
    BackColor=$FF0000
    BackColor2=$000000
    ...
    SourceDir=Y:\page-dev\page
    OutputDir=Y:\page-dev
    OutputBaseFilename=page-7.6
    ChangesEnvironment=yes

[Files]
    Source: Y:\page-dev\page\*; DestDir: {app}; Flags: recursesubdirs
