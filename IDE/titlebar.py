...
class TitleTk(tk.Tk):
    ...
    def __init__(self):
        ...
        self.titlebar = ttk.Frame(self, height=30)
        ...
        self.maximize = ttk.Button(
            self.titlebar,
            text="☐",
            font=(None, 11),
            command=self.maximize_window,
        )
        self.minimize = ttk.Button(
            self.titlebar,
            text="—",
            font=(None, 12),
            **self.settings,
        ...
        self.maximize.pack(side="right", fill="y")
        self.minimize.pack(side="right", fill="y")
