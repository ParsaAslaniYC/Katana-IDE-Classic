...
class App(tk.Frame):
    def __init__(self, parent, **kwargs):
        ...
        ## Terminal screen
        ########################################################################
        self.frameTerminal = tk.Frame(self, borderwidth=0, relief=FLAT, bg=self.TerminalColors["bg"], width=50, height=25)
        ...
        self.ver = pt.release()
        self.release = pt.version()
        self.TerminalScreen.insert("end", "KATA-Terminal Emulator\n\n","Running On", self.system, "Version", self.ver, self.release, "\n\n")
    ...
    def do_return(self, *args):
        ...
        # Valid command
            ...
            if cmd == "clear" or cmd == "reset":
                self.clear_screen()
            if cmd == "stdio3_goto_secret" or cmd == "iostream17_goto_secret":
                from tkinter import messagebox
                messagebox.showinfo("HAPPYEST DAY!!","Finaly You Found the Secret key Fucker\nTHE Real Creator of Katana IDE is Parsa Aslani\nBOORINGA!")
                return 0            
